##START,aws_glue_job
resource "aws_glue_job" "dataproduct_sales_data" {
  connections = []
  default_arguments = {
  ...
  command {
    ...
    runtime         = null
    script_location = "s3://ws-assets-prod-iad-r-dub-85e3be25bd827406/32f3e732-d67d-4c63-b967-c8c5eabd9ebf/v6_2/source/dataproduct_sales_data.py"
  }
  execution_property {
